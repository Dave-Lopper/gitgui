...
export default function ModernDropdownTrigger({
  ...
  return (
    <div
      role="button"
      className={`font-modern bg-modern-dark-pri border-modern-dark-border flex h-24 w-full cursor-pointer items-center justify-center border-1 border-b-1 font-bold text-white ${isFocused ? "outline-2 outline-offset-0 outline-sky-500 outline-solid" : ""}`}
    >
      {copy}
      <span
        className="ml-4"
