...
//       currentHunk.lines = [
//         ...currentHunk.lines,
//         ...currentHunkPart.removedLines.filter((line) => line.parts.length > 0),
//         ...currentHunkPart.addedLines.filter((line) => line.parts.length > 0),
...
//         // console.log({
//         //   linePart,
//         //   trailingContext: currentHunkPart.trailingContext,
//         //   hasAddedPart,
//         //   hasRemovedPart,
//         // });
//       }
...
const diff = `diff --git a/client/application/use-cases/authenticate.ts b/client/application/use-cases/authenticate.ts
index defd5df..eb860d1 100644
--- a/client/application/use-cases/authenticate.ts
+++ b/client/application/use-cases/authenticate.ts
...
console.log(JSON.stringify(parseFileDiff(diff)));
